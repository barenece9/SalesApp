package apps.lnsel.com.ambujasales.helpers.CustomAdapter.MeetingsAdapter;
...
public class MeetingsBaseAdapter extends BaseAdapter {
    ...
    public View getView(final int position, final View view, ViewGroup parent) {
        ...
        TextView tv_customer_shop_name = (TextView) rowView.findViewById(R.id.cardview_meetings_tv_customer_shop_name);
        ...
        tv_customer_shop_name.setText(meetingsList.get(position).getMtnCustomerShopName());
        ...
        else
        {
            for (MeetingsSetterGetter wp : arraylist)
            {
                if (wp.getMtnName().toLowerCase(Locale.getDefault()).contains(charText)||
                        ...
                        wp.getMtnCustomerShopName().toLowerCase(Locale.getDefault()).contains(charText)||
