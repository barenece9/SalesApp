package apps.lnsel.com.ambujasales.notification;
...
public class FirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        if(isNetworkAvailable() && session.isLoggedIn()){
            ...
            if(!session.getKeyUserFirebaseToken().equalsIgnoreCase(token)){
                //sendRegistrationTokenToServer(UrlUtil.TOKEN_UPDATE_URL,session.getUserID(),token);
            }
    ...
    public void sendRegistrationTokenToServer(String url, final String userId, final String token) {
    ...
    public void successInfo(String token){
        session.updateFcmTokenId(token);
    }
