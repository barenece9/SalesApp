...
import apps.lnsel.com.ambujasales.helpers.CustomAdapter.CustomerDetailsAdapter.CustomerDetailsSetterGetter;
import apps.lnsel.com.ambujasales.helpers.VolleyLibrary.AppController;
import apps.lnsel.com.ambujasales.views.Dashboard.activities.CustomerDetailsScreen.CustomerDetailsActivityView;
...
public class CustomerDetailsPresenter {
    ...
    public void addCustomerMeetingService(String url, final String userId, final String mtnCustomerId, final String mtnName, final String mtnDate, final String mtnTime, final String userParentPath) {
