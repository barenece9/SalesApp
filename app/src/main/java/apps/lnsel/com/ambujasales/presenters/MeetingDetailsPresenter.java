...
import apps.lnsel.com.ambujasales.helpers.CustomAdapter.MeetingDetailsAdapter.MeetingDetailsSetterGetter;
...
import apps.lnsel.com.ambujasales.views.Dashboard.activities.MeetingDetailsScreen.MeetingDetailsActivityView;
...
public class MeetingDetailsPresenter {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("success")){
                                ...
                                MeetingsData.get_current_mtnCustomerShopName = jsonObj.getString("mtnCustomerShopName");
    ...
    public void updateMeetingNextVisitService(String url, final String userId, final String mtnId, final String mtnCustomerId, final String mtnName, final String mtnDate, final String mtnTime, final String userParentPath) {
