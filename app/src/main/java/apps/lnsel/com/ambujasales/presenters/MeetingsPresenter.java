...
import apps.lnsel.com.ambujasales.helpers.CustomAdapter.MeetingsAdapter.MeetingsSetterGetter;
import apps.lnsel.com.ambujasales.helpers.VolleyLibrary.AppController;
import apps.lnsel.com.ambujasales.views.Dashboard.activities.MeetingsScreen.MeetingsActivityView;
                        ...
                        try {
                            ...
                            if(status.equals("failed")){
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    String mtnCustomerShopName = e.getString("mtnCustomerShopName");
                                    ...
                                    MeetingsSetterGetter wp = new MeetingsSetterGetter(mtnId, mtnName, mtnVisited, mtnNextVisit, mtnSignature, mtnPicture, mtnRemarks, mtnCustomerId, mtnCustomerName, mtnCustomerShopName, mtnCustomerMobileNo, mtnCustomerAddress, mtnCustomerLat, mtnCustomerLong, mtnUserId, mtnUserName, mtnDate, mtnTime, mtnParentName);
