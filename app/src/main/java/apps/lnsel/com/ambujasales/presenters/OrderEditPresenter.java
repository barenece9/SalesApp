...
import apps.lnsel.com.ambujasales.views.Dashboard.activities.OrderEditScreen.OrderEditActivityView;
...
public class OrderEditPresenter {
    ...
    public void updateOrderService(String url, final String userId, final String ordId, final String ordName, final String ordAmount, final String ordDescription){
