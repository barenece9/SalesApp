...
public class UrlUtil {
    ...
    //public static String MAIN_URL = "http://app.lnsel.in/salesapp/";
    public static String MAIN_URL = "http://61.16.131.205/salesmanagement/";
    ...
    public static String TOKEN_UPDATE_URL = BASE_URL+"";
}
