package apps.lnsel.com.ambujasales.views.Dashboard;
...
import apps.lnsel.com.ambujasales.helpers.NavigationDrawer.NavItem;
import apps.lnsel.com.ambujasales.helpers.NavigationDrawer.NavListAdapter;
import apps.lnsel.com.ambujasales.helpers.Service.GPSService;
import apps.lnsel.com.ambujasales.helpers.Service.LocationService;
import apps.lnsel.com.ambujasales.notification.NotificationConfig;
import apps.lnsel.com.ambujasales.presenters.MainPresenter;
...
public class MainActivity extends AppCompatActivity implements MainActivityView {
    ...
    private void displayFirebaseRegId() {
        ...
        if(isNetworkAvailable() && session.isLoggedIn()) {
            if(!session.getKeyUserFirebaseToken().equalsIgnoreCase(regId)) {
                //presenter.sendRegistrationTokenToServer(UrlUtil.TOKEN_UPDATE_URL, session.getUserID(), regId);
            }
        }
    }
    ...
    public void updateFCMToken(String usrPushToken){
