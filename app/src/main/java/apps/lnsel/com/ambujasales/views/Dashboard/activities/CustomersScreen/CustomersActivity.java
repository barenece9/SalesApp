package apps.lnsel.com.ambujasales.views.Dashboard.activities.CustomersScreen;
...
import apps.lnsel.com.ambujasales.helpers.CustomAdapter.CustomersAdapter.CustomersBaseAdapter;
import apps.lnsel.com.ambujasales.helpers.CustomAdapter.CustomersAdapter.CustomersData;
import apps.lnsel.com.ambujasales.presenters.CustomersPresenter;
    ...
    public void startGetCustomerInfo() {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                CustomersData.selectedCustomerShopName = adapter.getCustomerShopName(position).toString();
