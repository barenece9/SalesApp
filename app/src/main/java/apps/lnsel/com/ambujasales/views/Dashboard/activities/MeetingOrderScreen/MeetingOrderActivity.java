package apps.lnsel.com.ambujasales.views.Dashboard.activities.MeetingOrderScreen;
...
import apps.lnsel.com.ambujasales.presenters.MeetingOrderPresenter;
...
public class MeetingOrderActivity extends AppCompatActivity implements MeetingOrderActivityView {
    ...
    EditText et_order_name,activity_meeting_order_et_quantity, et_order_amount, et_order_description;
    TextInputLayout til_order_name,activity_meeting_order_til_quantity, til_order_amount, til_order_description;
    Button btn_cancel, btn_submit;
    Spinner activity_meeting_order_spinner_venues,activity_meeting_order_spinner_unit;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Add Meeting Order");
        ...
        activity_meeting_order_spinner_venues=(Spinner)findViewById(R.id.activity_meeting_order_spinner_venues);
        activity_meeting_order_spinner_unit=(Spinner)findViewById(R.id.activity_meeting_order_spinner_unit);
        ...
        activity_meeting_order_et_quantity=(EditText)findViewById(R.id.activity_meeting_order_et_quantity);
        ...
        activity_meeting_order_til_quantity=(TextInputLayout)findViewById(R.id.activity_meeting_order_til_quantity);
        ...
        activity_meeting_order_et_quantity.addTextChangedListener(new MyTextWatcher(activity_meeting_order_et_quantity));
        ...
        venuesAdapter = new ArrayAdapter<String>(MeetingOrderActivity.this,R.layout.spinner_rows, venuesList);
        venuesAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        activity_meeting_order_spinner_venues.setAdapter(venuesAdapter);

        activity_meeting_order_spinner_venues.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        activity_meeting_order_spinner_unit.setAdapter(unitAdapter);

        activity_meeting_order_spinner_unit.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
    ...
    public void submitMeetingOrder(){
        if(isNetworkAvailable()){
            ...
            presenter.addMeetingOrderRequest(UrlUtil.ADD_MEETING_ORDER_URL, ordMeetingId, userId, userParentPath, ordName, ordAmount, ordDescription, ordDate, ordTime);
